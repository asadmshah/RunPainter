...
import com.asadmshah.runpainter.injection.factories.NewRunScreenComponentFactory;
...
public class NewRunScreenFragment extends Fragment implements NewRunScreenContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        NewRunScreenComponentFactory.create(RunPainterApplication.getComponent(getActivity()), this).inject(this);
    }
